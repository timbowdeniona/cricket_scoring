  ...
  return (
    <div className="flex items-center gap-1.5 flex-wrap">
      ...
      <button
        ...
        className="px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs flex items-center gap-1.5 shadow transition-all active:scale-95"
      ...
      <button
        ...
        className="px-3 py-1.5 rounded-lg bg-black hover:bg-gray-900 text-white font-bold text-xs flex items-center gap-1.5 shadow border border-gray-700 transition-all active:scale-95"
      ...
      <button
        ...
        className="px-3 py-1.5 rounded-lg bg-blue-700 hover:bg-blue-600 text-white font-bold text-xs flex items-center gap-1.5 shadow transition-all active:scale-95"
      ...
      <button
        ...
        className="px-3 py-1.5 rounded-lg bg-malpas-blue hover:bg-blue-600 text-white font-bold text-xs flex items-center gap-1.5 shadow border border-blue-400/40 transition-all active:scale-95"
